...
class ParkingLocationSeeder extends Seeder
{
    public function run()
    {
        $locations = [
            ...
            [
                'name' => 'CB Parking Lot',
                'address' => 'Nkrumah Rd, Kampala, Uganda',
                'lat' => 0.3136,
                'lng' => 32.5811,
                'rating' => 4.8,
                'price' => 1000,
            ...
            [
                ...
                'address' => 'Sir Apollo Kaggwa Rd, Kampala',
                'lat' => 0.32702,
                'lng' =>  32.5669,
                'rating' => 4.2,
                'price' => 2000,
            ...
            [
                ...
                'address' => 'Nasser Rd, Kampala, Uganda',
                'lat' => 0.3367,
                'lng' => 32.5958,
                'rating' => 4.7,
                'price' => 3000,
            ...
            [
                'name' => 'PLÀN B NIGHT PARKING',
                'address' => 'Busabala road, Kampala, Uganda',
                'lat' => 0.3239,
                'lng' => 32.5758,
                'rating' => 4.6,
                'price' => 1600,
            ...
            [
                'name' => 'Park Enkadde Mall',
                'address' => ' Ben Kiwanuka St, Kampala',
                'lat' => 0.31299,
                'lng' => 32.57656,
                'rating' => 4.1,
                'price' => 1000,
